"""
Handler for ValueTable form attributes.

ValueTables are form-level temporary data tables (not persisted).
"""
...
class ValueTableHandler(BaseElementHandler):
    """
    Handler for ValueTable sync operations.

    YAML location: forms[].value_tables[]
    XML location: Form.xml form attributes with ValueTable type
    """
    ...
    def extract_from_xml(
        ...
        """Extract value table data from XML."""
    ...
    def get_elements_from_tree(
        ...
        """Get value tables from Form.xml."""
        ns = namespaces or self.NAMESPACES
        tables = {}
        ...
        # Look for form attributes with ValueTable type
    ...
    def compare_element_details(
        ...
        # ValueTable changes are mostly structural (columns)
        return []
    ...
    def check_references(
        ...
        """Check for references to value table in BSL."""
        references = []
