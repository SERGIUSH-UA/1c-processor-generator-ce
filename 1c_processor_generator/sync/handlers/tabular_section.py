"""
Handler for Tabular Sections.

Tabular sections are processor-level collections of rows (like mini-tables).
"""
...
class TabularSectionHandler(BaseElementHandler):
    """
    Handler for tabular section sync operations.

    YAML location: tabular_sections[]
    XML location: //ns:TabularSection
    """
    ...
    def extract_from_xml(
        ...
        """Extract tabular section data from XML."""
    ...
    def get_elements_from_tree(
        ...
        """Get tabular sections from processor XML."""
        ns = namespaces or self.NAMESPACES
        sections = {}
    ...
    def delete_from_yaml(
        ...
        """Delete tabular section from YAML."""
        if 'tabular_sections' not in config:
            return False
    ...
    def check_references(
        ...
        """Check for references to tabular section in BSL."""
        references = []
